...
export const Hero = () => {
  return (
    <section className="hidden md:flex flex-col relative min-h-[588px] w-full max-w-[1181px] items-center mt-[33px] pt-[556px] pb-[18px] px-[70px] max-md:max-w-full max-md:pt-[100px] max-md:px-5">
      <img
