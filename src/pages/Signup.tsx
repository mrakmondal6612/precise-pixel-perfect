...
const Signup = () => {
  ...
  const handleSignup = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Signup attempt with:', { firstName, lastName, email, password, phone, acceptTerms });
              ...
              <CardContent className="p-6">
                ...
                <form onSubmit={handleSignup} className="space-y-4">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="h-4 w-4 text-[#D92030] focus:ring-[#D92030] border-gray-300 rounded"
                      required
                    />
                  ...
                  <div className="grid grid-cols-4 gap-2 text-xs">
                    <span className="bg-gray-100 p-2 rounded text-center">Senior</span>
                    <span className="bg-gray-100 p-2 rounded text-center">Male</span>
                    <span className="bg-gray-100 p-2 rounded text-center">Female</span>
                    <span className="bg-gray-100 p-2 rounded text-center">Other</span>
                  </div>
                ...
                <div className="text-center mt-6">
                  ...
                  <div className="space-y-3">
                    <Button variant="outline" className="w-full py-2 h-auto">
